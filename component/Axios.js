  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.blue}>Get Data Using Async Await GET</Text>
      </TouchableOpacity>

      <TouchableOpacity
        style={styles.buttonStyle}
        onPress={postDataUsingSimplePostCall}>
        <Text style={styles.blue}>Post Data Using POST</Text>
      </TouchableOpacity>

      <TouchableOpacity
        style={styles.buttonStyle}
        onPress={multipleRequestsInSingleCall}>
        <Text style={styles.blue}>Multiple Concurrent Requests In Single Call</Text>
      </TouchableOpacity>
